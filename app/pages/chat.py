...
def create_message_bubble(message, is_user=True):
    ...
    if is_user:
        return dbc.Card(
            dbc.CardBody([
                html.Div(message, className="mb-0")
            ]),
        ...
        return dbc.Card(
            dbc.CardBody([
                    ...
                    html.Div([
                        dbc.Card([
                            dbc.CardBody([
                                html.A(
                                    [
                                        html.Strong(src.get("title", "Untitled")[:100]),
                                        html.Br(),
                                        html.Small(
                ...
                ], className="mt-2") if sources else None
            ]),
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.H1("Research Assistant Chat", className="display-5 fw-bold text-center text-dark mt-4"),
            html.P(
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardHeader([
                    ...
                    dbc.Button(
                        [html.I(className="bi bi-plus-circle me-1"), "Add Paper"],
                        id="add-paper-btn",
                        color="primary",
                        size="sm",
                        className="float-end"
                ...
                dbc.CardBody([
                    html.Div(id="context-papers-list", children=[
                        dbc.Alert(
    ...
    dbc.Modal([
        ...
        dbc.ModalBody([
            ...
            html.Div(id="paper-search-results", style={"maxHeight": "400px", "overflowY": "auto"})
        ]),
        dbc.ModalFooter(
            dbc.Button("Close", id="close-modal-btn", className="ms-auto")
        )
    ], id="add-paper-modal", size="lg", is_open=False),
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div([
                                ...
                                html.P("Ask me anything about the research papers in the database.", className="text-muted")
...
@callback(
    Output("paper-search-results", "children"),
    Input("paper-search-modal", "value")
)
def search_papers_modal(search_query):
    ...
    try:
        ...
        with engine.connect() as connection:
            df = pd.read_sql_query(query, connection, params={'search': f'%{search_query}%'})
            ...
            dbc.ListGroup([
                dbc.ListGroupItem([
                    html.Div([
                        ...
                        dbc.Button(
                            "Add",
                            id={"type": "add-context-paper", "index": row['paper_id']},
                            color="primary",
                            size="sm",
                            className="float-end"
                        )
                ...
                dbc.Card([
                    dbc.CardBody([
                        ...
                        html.Small(
                            ...
                            className="text-muted"
                        ) if paper.get('keywords') else None
                    ])
                ], className="mb-2")
            )

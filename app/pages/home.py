...
) if not df_publications.empty else go.Figure()
...
) if not df_subjects.empty else go.Figure()
...
) if not df_keywords.empty else go.Figure()
...
) if not df_countries.empty else go.Figure()
...
def stat_card(title: str, value: str | int, subtitle: str | None = None, color: str = "primary"):
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            dbc.CardHeader(
                                html.H5(
                                    "Top 10 Most Cited Papers", className="mb-0 fw-semibold"
                                )
                            ),
                            dbc.CardBody(
                                dag.AgGrid(
                                    rowData=df_top_cited.to_dict("records")
                                ...
                                if not df_top_cited.empty
                                else html.P("No data available", className="text-muted"),
                            ),
                        ],
                        className="shadow-sm h-100",
                    ),
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody(
                                dag.AgGrid(
                                    rowData=df_top_authors.to_dict("records")
            ...
            [
                dbc.Col(
                    dbc.Card(
                        [
                            dbc.CardHeader(
                                html.H5("Top Subject Areas", className="mb-0 fw-semibold")
                            ),
                            dbc.CardBody(
                                dcc.Graph(
                                    id="subject-areas",
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody(
                                dag.AgGrid(
                                    rowData=df_institutions.to_dict("records")
